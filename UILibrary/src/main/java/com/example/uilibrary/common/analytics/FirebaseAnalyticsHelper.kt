...
internal class FirebaseAnalyticsHelper
    ...
    constructor(
        ...
        override fun logEvent(
            ...
            if (eventType == AnalyticsEvent.Types.BUTTON_CLICK) {
                event =
                    AnalyticsEvent(
                        type = AnalyticsEvent.Types.BUTTON_CLICK,
                        extras =
                            listOf(
                                AnalyticsEvent.Param(AnalyticsEvent.ParamKeys.BUTTON_NAME, name),
                            ),
                    )
            } else {
                event =
                    AnalyticsEvent(
                        ...
                        extras =
                            listOf(
                                AnalyticsEvent.Param(AnalyticsEvent.ParamKeys.SCREEN_NAME, name),
                            ),
                    )
            }
