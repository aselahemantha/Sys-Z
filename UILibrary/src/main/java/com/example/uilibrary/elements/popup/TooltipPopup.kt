    ...
    if (isShowTooltip) {
        TooltipPopup(
            ...
            Text(
                modifier =
                    Modifier
                        .padding(horizontal = 12f.scaleWidth())
                        .padding(vertical = 8f.scaleHeight()),
                text = toolTipText,
                style =
                    TextStyle(
...
fun TooltipPopup(
    ...
    backgroundColor: Color = LocalCustomColorsPalette.current.figmaColors.Grey0,
    arrowHeight: Dp = 4.dp,
...
fun BubbleLayout(
    ...
    val grey = LocalCustomColorsPalette.current.figmaColors.Grey0
    val arrowHeightPx =
        with(LocalDensity.current) {
            arrowHeight.toPx()
        }
